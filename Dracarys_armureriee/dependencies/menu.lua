...
local defaultMenu = { { name = "Aucune armes est disponibles" } }
...
function DrawText2(intFont, stirngText, floatScale, intPosX, intPosY, color, boolShadow, intAlign, addWarp)
 ...
 ---- ---- KIIIIIKKKIII DRRRRAAACCARRRYYYYSSSDRRRACARYS

function PMenu:drawMenuButton(button, intX, intY, boolSelected, intW, intH, intID)
	local tableColor, add, currentMenuData = boolSelected and (button.colorSelected or {0, 0, 0, 200}) or (button.colorFree or { 0, 0, 0, 0 }), .0, self.Menu[self.Data.currentMenu]
	DrawRect(intX, intY, intW, intH, tableColor[1], tableColor[2], tableColor[3], tableColor[4])
	tableColor = boolSelected and {241, 239, 239} or {255, 255, 255}
...
end -- 0.01 ms ik ben de mooiste oen
...
function AskEntry(callback, name, lim, default)
	AddTextEntry('FMMC_KEY_TIP8', name or "Montant")-- 0.01 ms jongen
